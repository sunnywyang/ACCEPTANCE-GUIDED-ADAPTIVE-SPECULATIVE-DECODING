...
if __name__ == "__main__":
    ...
    if training_args.evaluate_only:
        ...
        # python3 train-llama13b.py     --data_path /root/autodl-tmp/SpecDec_pp-main/specdec_pp/data/llama_13b_1w4data/train.json    --eval_data_path /root/autodl-tmp/SpecDec_pp-main/specdec_pp/data/llama_13b_1w4data/dev.json     --output_dir llama13b-layer1-mixing0.5    --bf16 True     --per_device_train_batch_size 4    --num_train_epochs 3     --gradient_accumulation_steps 8     --logging_steps 5     --evaluation_strategy epoch     --per_device_eval_batch_size 4     --weight_mismatch 6.0     --save_strategy no     --warmup_ratio 0.03    --lr_scheduler_type cosine     --resnet_num_layers 1     --mixing_ratio 0.5