...
#python gen_assistant.py --do_sample --input_file /root/autodl-tmp/SpecDec_pp-main/specdec_pp/data/llama_13b_3w8data/tmp1.json --output_file /root/autodl-tmp/SpecDec_pp-main/specdec_pp/data/llama_13b_3w8data/tmp2.json