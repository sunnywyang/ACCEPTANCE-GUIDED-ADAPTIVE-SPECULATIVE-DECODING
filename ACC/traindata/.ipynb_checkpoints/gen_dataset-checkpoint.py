...
def parse_args():
    ...
    parser.add_argument('--n_begin', type=int, default=14001)
...
if __name__ == "__main__":
    args = parse_args()
    main(args)
#python gen_dataset.py --dataset_name tatsu-lab/alpaca --model_name 13b --mode hf --do_sample --output_file /root/autodl-tmp/SpecDec_pp-main/specdec_pp/data/llama_13b_data/tmp1.json

#python gen_dataset.py --dataset_name tatsu-lab/alpaca --model_name 13b --mode hf --do_sample --output_file /root/autodl-tmp/SpecDec_pp-main/specdec_pp/data/llama_13b_3w8data/tmp1.json