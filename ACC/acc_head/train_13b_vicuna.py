...
if __name__ == "__main__":
    ...
    base_model_path="/root/autodl-tmp/Vicuna-13B-v1.3/"
    eagle_model_path="/root/autodl-fs/EAGLE/eagle_model/EAGLE-Vicuna-13B-v1.3/"
    import sys
    sys.path.append('/root/autodl-fs/EAGLE/eagle/model/') 
    from ea_modelcopy import EaModel  # your local EAGLE model
    ...
    if training_args.evaluate_only:
        ...
        # python3 train_13b_vicuna.py     --data_path /root/autodl-fs/vicuna_13b_5w2/train.json    --eval_data_path /root/autodl-fs/vicuna_13b_5w2/dev.json     --output_dir exp-weight6.0-layer1    --bf16 True     --per_device_train_batch_size 4    --num_train_epochs 5     --gradient_accumulation_steps 8     --logging_steps 5     --evaluation_strategy epoch     --per_device_eval_batch_size 4     --weight_mismatch 6.0     --save_strategy no     --warmup_ratio 0.03    --lr_scheduler_type cosine     --resnet_num_layers 1     --mixing_ratio 0.5