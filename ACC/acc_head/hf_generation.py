        ...
        # for _ in range(int(assistant_model.max_assistant_tokens)):
            ...
            if num_assistant_tokens_schedule == 'ada':
                ...
                if stop_threshold is None:
                    ...
                    #若拒绝概率超过 stop_threshold，则判定停止生成
                ...
                #结合 bound 条件（生成的 token 数量的上下限）来判断是否停止生成
