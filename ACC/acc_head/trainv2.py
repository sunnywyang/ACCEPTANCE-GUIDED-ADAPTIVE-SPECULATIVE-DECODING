...
if __name__ == "__main__":
    ...
    base_model_path="/root/autodl-tmp/Vicuna-7B-v1.3/"
    eagle_model_path="/root/autodl-fs/EAGLE/eagle_model/EAGLE-Vicuna-7B-v1.3/"
    import sys
    sys.path.append('/root/autodl-fs/EAGLE/eagle/model/') 
    from ea_modelcopy import EaModel  # your local EAGLE model
    ...
    if training_args.evaluate_only:
        ...
        # python3 trainv2.py     --data_path /root/autodl-fs/SpecDec_pp-main/vicuna7b_alldata/train.json    --eval_data_path /root/autodl-fs/SpecDec_pp-main/vicuna7b_alldata/dev.json     --output_dir llama7b-layer1-mixing0.5    --bf16 True     --per_device_train_batch_size 4    --num_train_epochs 5     --gradient_accumulation_steps 8     --logging_steps 5     --evaluation_strategy epoch     --per_device_eval_batch_size 4     --weight_mismatch 6.0     --save_strategy no     --warmup_ratio 0.03    --lr_scheduler_type cosine     --resnet_num_layers 1     --mixing_ratio 0.5